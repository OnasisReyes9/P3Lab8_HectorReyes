...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p3lab8_hectorreyes.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p3lab8_hectorreyes.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p3lab8_hectorreyes ${OBJECTFILES} ${LDLIBSOPTIONS}
